...
if ~exist(snapdir, 'dir')
    snapdir = fullfile('example5', 'snapshots_annulus_gamma40_N501');
end
...
desiredTimes = [0, 0.30, 0.60, 0.87, 1.00, 2.];
...
tickFontSize = 25;
colorbarFontSize = 25;
colorbarLabelFontSize = 25;
superTitleFontSize = 25;
